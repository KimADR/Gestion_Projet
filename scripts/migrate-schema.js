...
async function migrateSchema() {
  ...
  try {
    ...
    // Drop dependent foreign keys and tables first
    console.log('⏳ Dropping dependent tables...');
    await client.query('DROP TABLE IF EXISTS leave_balances CASCADE');
    
    // Now we can safely drop vacation_types
    await client.query('DROP TABLE IF EXISTS vacation_types CASCADE');
    
    console.log('✅ Old tables dropped');
    
    // Create full database schema matching lib/db-schema.sql
    await client.query(`
    ...
    console.log('✅ Full schema created or verified');
    
    // Insert new vacation types
    await client.query(`
    ...
    console.log('✅ New vacation types and departments inserted');
